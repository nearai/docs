...
// Extend the types to support customProps
...
function CategoryLinkLabel({label, icon}: {label: string; icon?: string}) {
  return (
    <>
    ...
    <li
      ...
      <div
        ...
        <Link
          ...
          {...props}>
          <CategoryLinkLabel label={label} icon={item.customProps?.icon} />
        </Link>
        {href && collapsible && (
          <CollapseButton
            collapsed={collapsed}
