...
| `privacy-filter.completions.near.ai` | Privacy Filter | Text | PII classification |
...
- `POST /v1/privacy/classify` — PII detection (`/v1/privacy/redact` is additionally available via the gateway)
