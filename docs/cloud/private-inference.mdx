...
<FeatureCardGrid>
  ...
  <FeatureCard
    ...
    description="Verify that your HTTPS connection terminates inside the TEE using hardware-backed TLS attestation"
    href="/cloud/verification/tls"
  />
  <FeatureCard
    icon={DocsIcon}
    title="E2EE Chat Completions"
    description="Add client-side encryption for defense-in-depth protection of your messages (deprecated)"
