...
| Subdomain | Model |
|-----------|-------|
| `qwen35-122b.completions.near.ai` | Qwen3.5-122B |
| `deepseek-v31.completions.near.ai` | DeepSeek-V3.1 |
| `qwen3-30b.completions.near.ai` | Qwen3-30B |
| `gpt-oss-120b.completions.near.ai` | OpenAI GPT-OSS-120B |
| `glm-5.completions.near.ai` | GLM-5 |
| `qwen3-vl-30b.completions.near.ai` | Qwen3-VL-30B (vision) |
| `flux2-klein.completions.near.ai` | FLUX.2-klein-4B (image generation) |
| `whisper-large-v3.completions.near.ai` | Whisper Large V3 (audio transcription) |
| `qwen3-embedding.completions.near.ai` | Qwen3-Embedding-0.6B |
| `qwen3-reranker.completions.near.ai` | Qwen3-Reranker-0.6B |
