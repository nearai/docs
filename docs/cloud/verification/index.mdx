...
:::tip Simplified Verification with Direct Completions
...
:::tip TLS Termination Inside the TEE
...
<FeatureCardGrid>
  ...
  <FeatureCard
    ...
    description="Verify that your HTTPS connection terminates inside the attested TEE by binding the TLS certificate into report_data"
    href="/cloud/verification/tls"
  />
  <FeatureCard
    icon={ChatIcon}
