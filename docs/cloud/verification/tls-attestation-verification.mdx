...
When you make an HTTPS request to a model endpoint, how do you know the TLS connection actually terminates inside the TEE — and not at some intermediary? TLS attestation answers this question.
