...
The endpoint advertises both `z-ai/glm-5.2` and `zai-org/GLM-5.2-FP8`. Use `z-ai/glm-5.2` first. Treat `zai-org/GLM-5.2-FP8` as an alias or direct completions fallback only when the direct completions endpoint lists it and your client needs that served model name.
