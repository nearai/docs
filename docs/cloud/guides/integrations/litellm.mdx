...
Sources checked: 2026-06-23. References: [LiteLLM OpenAI-compatible endpoints](https://docs.litellm.ai/docs/providers/openai_compatible), [LiteLLM proxy config](https://docs.litellm.ai/docs/proxy/configs), and [LiteLLM API key/base configuration](https://docs.litellm.ai/docs/set_keys).
