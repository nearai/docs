...
For example, `https://deepseek-v31.completions.near.ai/v1` connects directly to DeepSeek-V3.1. See [completions.near.ai/endpoints](https://completions.near.ai/endpoints) for all available endpoints.
