...
All of the above also work on each model's own [direct completions endpoint](/cloud/private-inference#direct-completions) (e.g. `qwen3-embedding.completions.near.ai`, `flux2-klein.completions.near.ai`), where TLS terminates directly inside the model's TEE.
