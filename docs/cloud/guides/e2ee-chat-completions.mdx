...
sequenceDiagram
    participant Client
    participant ModelTEE as Model TEE (deepseek-v31.completions.near.ai)
...
curl "https://deepseek-v31.completions.near.ai/v1/attestation/report?signing_algo=ecdsa"
```
...
# response = requests.get(
#     "https://deepseek-v31.completions.near.ai/v1/attestation/report",
...
# Or via direct completions:
# curl https://deepseek-v31.completions.near.ai/v1/chat/completions \
#   -H "Content-Type: application/json" \
#   -H "Authorization: Bearer YOUR_API_KEY" \
#   -H "X-Signing-Algo: ecdsa" \
#   -H "X-Client-Pub-Key: YOUR_CLIENT_PUBLIC_KEY_HEX" \
...
# base_url = "https://deepseek-v31.completions.near.ai/v1"  # Direct
...
// const baseUrl = 'https://deepseek-v31.completions.near.ai/v1';  // Direct
