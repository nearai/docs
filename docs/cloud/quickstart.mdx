...
Each model has its own subdomain. For example, DeepSeek-V3.1 is available at `deepseek-v31.completions.near.ai`:
...
client = openai.OpenAI(
    base_url="https://deepseek-v31.completions.near.ai/v1",
    api_key="YOUR_API_KEY"
)
...
const openai = new OpenAI({
    baseURL: 'https://deepseek-v31.completions.near.ai/v1',
    apiKey: 'YOUR_API_KEY',
});
