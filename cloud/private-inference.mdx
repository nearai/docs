...
icon: "/images/icons/private-inference.svg"
---
...
<CardGroup cols={3}>
  <Card title="Complete Privacy" icon="/images/icons/private-inference.svg" horizontal>
  ...
  <Card title="Cryptographic Verification" icon="/images/icons/verification.svg" horizontal>
  ...
  <Card title="Production Performance" icon="/images/icons/performance.svg" horizontal>
...
<CardGroup cols={3}>
  ...
  <Card title="TLS Attestation Verification" icon="/images/icons/docs.svg" href="/cloud/verification/tls">
    Verify that your HTTPS connection terminates inside the TEE using hardware-backed TLS attestation
  </Card>
  <Card title="E2EE Chat Completions" icon="/images/icons/docs.svg" href="/cloud/guides/e2ee-chat-completions">
