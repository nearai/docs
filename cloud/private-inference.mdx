...
description: "NEAR AI Cloud uses Intel TDX and NVIDIA TEEs to ensure your prompts and outputs remain private from cloud operators, model providers, and NEAR itself."
---
