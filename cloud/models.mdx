...
- **TEE-hosted models** (marked <span className="doc-badge">TEE</span>) run on NEAR AI's own GPU fleet inside [Trusted Execution Environments](/cloud/private-inference). They support [attestation, signatures, and verification](/cloud/verification), and nobody — not even NEAR — can see your prompts or outputs.
