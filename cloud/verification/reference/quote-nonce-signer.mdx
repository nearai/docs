...
For a TypeScript SDK integration, choose the [NEAR AI Cloud Gateway](/cloud/verification/sdk/cloud-api) or a [direct model endpoint](/cloud/verification/sdk/direct).
